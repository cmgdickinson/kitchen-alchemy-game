...
As you discover more recipes, hungry customers show up on the **Order Board** asking for dishes you've made. Fulfilling orders earns coins and progresses you toward milestone unlocks of new ingredients — yeast, vanilla, chocolate, cheese, cream, baking powder, cinnamon, and lemon. Each new ingredient unlocks entirely new branches of the recipe tree.

Toggle the **Hints** button to see, on each pantry card, how many undiscovered recipes still use that ingredient.

The **Recipe Book** drawer at the bottom of the screen shows every recipe — known ones in full, undiscovered ones as `???` cards so you know how much is left to find.
...
96 tests across the data, state, combination, milestone, and order systems. Jest with Babel for ES-module → CommonJS translation.
